...
API ключи и другие чувствительные данные сейчас хранятся в открытом виде в config.json. Нужна система безопасного хранения и шифрования sensitive данных.
