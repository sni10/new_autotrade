...
class Deal:
    ...
    def __init__(self, deal_id: int, currency_pair: CurrencyPair, status: str = STATUS_OPEN, buy_order: Order = None, sell_order: Order = None, created_at: int = None, closed_at: int = None):
